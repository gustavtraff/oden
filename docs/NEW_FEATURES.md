...
|---|----------|-------------------|-----------|
| 1 | [Auto-reaktion vid sparad rapport](#1-auto-reaktion-vid-sparad-rapport) | `sendReaction` | Hög |
| 2 | [Läskvitton för bearbetade meddelanden](#2-läskvitton-för-bearbetade-meddelanden) | `sendReceipt` | Hög |
